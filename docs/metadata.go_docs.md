# metadata.go - Documentation

## File Metadata
- **Path**: `metadata.go`
- **Size**: 19335 bytes (552 lines)
- **Extension**: .go
- **Type**: Text file
...
- **of**: input
- **of**: output
- **SymbolMapping**: struct
- **MappingInterval**: struct
- **MetadataPrefix**: struct
- **MetadataHeaderV1**: struct
- **of**: input
- **of**: output
- **MetadataHeaderV2**: struct
- **of**: input
- **of**: output
