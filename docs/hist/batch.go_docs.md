# hist/batch.go - Documentation

## File Metadata
- **Path**: `hist/batch.go`
- **Size**: 16149 bytes (381 lines)
- **Extension**: .go
- **Type**: Text file
...
- **JobState**: string
- **JobExpiredError**: struct
- **Delivery**: string
- **BatchJob**: struct
- **of**: the
- **of**: the
- **with**: all
- **GetRangeParams**: struct
- **of**: the
- **of**: the
- **BatchFileDesc**: struct
- **with**: all
- **SubmitJobParams**: struct
- **of**: the
- **of**: the
