# hist/metadata.go - Documentation

## File Metadata
- **Path**: `hist/metadata.go`
- **Size**: 13537 bytes (458 lines)
- **Extension**: .go
- **Type**: Text file
...
- **of**: data
- **FeedMode**: uint8
- **MetadataQueryParams**: struct
- **of**: input
- **PublisherDetail**: struct
- **FieldDetail**: struct
- **UnitPricesForMode**: struct
- **ConditionDetail**: struct
...
- Test file: `hist/metadata_test.go`
- Run tests: `go test`
