# live/gateway.go - Documentation

## File Metadata
- **Path**: `live/gateway.go`
- **Size**: 4540 bytes (157 lines)
- **Extension**: .go
- **Type**: Text file
...
- **GreetingMsg**: struct
- **ChallengeRequestMsg**: struct
- **AuthenticationResponseMsg**: struct
- **AuthenticationRequestMsg**: struct
- **SubscriptionRequestMsg**: struct
- **SessionStartMsg**: struct
...
- Test file: `live/gateway_test.go`
- Run tests: `go test`
