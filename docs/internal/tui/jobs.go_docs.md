# internal/tui/jobs.go - Documentation

## File Metadata
- **Path**: `internal/tui/jobs.go`
- **Size**: 14297 bytes (529 lines)
- **Extension**: .go
- **Type**: Text file
...
- **JobsPageModel**: struct
- **JobsPageKeyMap**: struct
- **JobsMsg**: struct
- **FilesMsg**: struct
...
- Test file: `internal/tui/jobs_test.go`
- Run tests: `go test`
