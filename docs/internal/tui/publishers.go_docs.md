# internal/tui/publishers.go - Documentation

## File Metadata
- **Path**: `internal/tui/publishers.go`
- **Size**: 2601 bytes (113 lines)
- **Extension**: .go
- **Type**: Text file
...
- **PublishersPageModel**: struct
- **PublishersMsg**: struct
...
- Test file: `internal/tui/publishers_test.go`
- Run tests: `go test`
