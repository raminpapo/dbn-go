# internal/tui/downloads.go - Documentation

## File Metadata
- **Path**: `internal/tui/downloads.go`
- **Size**: 8218 bytes (280 lines)
- **Extension**: .go
- **Type**: Text file
...
- **QueueDownloadMsg**: struct
- **DownloadsPageModel**: struct
- **DownloadsPageKeyMap**: struct
...
- Test file: `internal/tui/downloads_test.go`
- Run tests: `go test`
