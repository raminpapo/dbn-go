# internal/tui/datasets.go - Documentation

## File Metadata
- **Path**: `internal/tui/datasets.go`
- **Size**: 5798 bytes (228 lines)
- **Extension**: .go
- **Type**: Text file
...
- Test file: `internal/tui/datasets_test.go`
- Run tests: `go test`
