# internal/tui/download_manager.go - Documentation

## File Metadata
- **Path**: `internal/tui/download_manager.go`
- **Size**: 9592 bytes (366 lines)
- **Extension**: .go
- **Type**: Text file
...
- Test file: `internal/tui/download_manager_test.go`
- Run tests: `go test`
